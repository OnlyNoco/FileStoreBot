...
MESSAGES = {
    ...
    "SHORT_MSG": "<b>📊 ʜᴇʏ {first},\n\n‼️ ᴛʜɪꜱ ꜱʜᴏʀᴛɴᴇʀ ɪꜱ ᴍᴀᴅᴇ ᴍʏ ᴍᴇ ꜱᴏ ᴍᴀx 6 ꜱᴇᴄᴏɴᴅꜱ ᴡᴀɪᴛ ᴀɴᴅ ᴀ ᴄʟɪᴄᴋ ɴᴏᴛʜɪɴɢ ᴇʟꜱᴇ ʏᴏᴜ ʜᴀᴠᴇ ᴛᴏ ᴅᴏ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ꜰɪʟᴇ ꜱᴏ, ᴡʜʏ ɴᴏᴛ ɢɪᴠᴇ ɪᴛ ᴀ ꜱʜᴏᴛ</b>",
    "ON_SHORT_MSG": "<b>📊 ʜᴇʏ {first},\n\n‼️ ɢᴇᴛ ᴀʟʟ ꜰɪʟᴇs ɪɴ ᴀ sɪɴɢʟᴇ ʟɪɴᴋ ‼️\n\n⌯ ʏᴏᴜʀ ʟɪɴᴋ ɪs ʀᴇᴀᴅʏ — ᴛᴀᴘ ᴏɴ ‘ᴏᴘᴇɴ ʟɪɴᴋ’ ᴛᴏ ᴠɪᴇᴡ.</b>",
