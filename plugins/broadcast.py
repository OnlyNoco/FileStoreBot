...
from helper.broadcasting import build_broadcast_status, broadcast_reply_message
...
async def send_text(client, message):
    ...
    if user_id in admin_ids:
        if message.reply_to_message:
            ...
            stats = await broadcast_reply_message(client, broadcast_msg, query)
            return await pls_wait.edit(build_broadcast_status(stats))
